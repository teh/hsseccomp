...
foreign import ccall unsafe "seccomp_init"
    c_seccomp_init :: CInt -> IO (Ptr CFilterCtx)

foreign import ccall "seccomp_reset"
    c_seccomp_reset :: Ptr CFilterCtx -> CInt -> IO CInt
